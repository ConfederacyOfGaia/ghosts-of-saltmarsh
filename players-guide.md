...
Use either point buy or standard array.

## Races

The following races are common in Saltmarsh, and can be used as PC races.
...
Halflings are the next most common race, split 75%/25% between Lightfoot and Stout varieties.  Most buildings are built to accommodate both human and halfing residents.

##### Elf

The Silverstand is home to a nation of wood elves. They trade with Saltmarsh but rarely make their homes there, though there are exceptions.

An occasional high elf arrives in Saltmarsh via ship, but very few of them stay. If you want to play a high elf, you will need a story of how you arrived in Saltmarsh, and why you've stayed.

##### Half-elf

Though elves are rare, half-elves are merely uncommon. Many residents of Saltmarsh find elven visitors... appealing.  You can choose the standard half-elf, or the wood elf or high elf varities from SCAG.

##### Dwarf

Dwarves are not native to this area, so if you're a dwarf you're part of the contingent of dwarven miners have been sent to Saltmarsh by King Skotti.  Both hill and mountain dwarves are represented equally.

##### Half-orc

Orcs are known to live on the far side of the swamps but generally keep to themselves.  Unlike orcs in other lands, these orcs are civilized and have a complex culture, so Saltmarsh sees the occasional half-breeds.

##### Others

There are only two tieflings in Saltmarsh, and they are native to the Free City of Greyhawk, not Saltmarsh. If you want to play a tiefling, you will have arrived with them.

Any races or subraces not mentioned above are unknown.

## Backgrounds

Pick a background that is thematically consistent with Saltmarsh, its environments, and its industries. You will roll on the *Lifestyle and Starting Resources* table, below, which will indicate how successful you were in your past (or possibly still are).

5E encourages you to create custom backgrounds that provide any two skills and any combination of two languages, tools, musical instruments, or gaming sets.  dndbeyond.com supports this natively.
...
First level feats are ok, subject to approval. They should be thematically consistent with your background, and the following feats are unavailble at first level:
...
Because the PCs live in Saltmarsh, each will have a job (with an accompanying lifestyle), a connection to one of the major NPCs in town (see *Roster of NPCs*, below), and a connection to 2 other PCs.  We'll figure this out during session 0.
...
|  3-4 | Poor        |   2 sp     | House (rented) | Debt x 2, Savings x 1
